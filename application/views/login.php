				...
				<div class="auth-box ">
					<div class="left">
						<div class="content" style="width:300px;">
							<div class="header">
								<div class="logo text-center"><img style = "width: 300px; height: 100px;" src="<?= base_url()?>assets/img/ps.png" alt="Klorofil Logo"></div>
								<p class="lead"></p>
							</div>
					...
					<div class="right">
						...
						<div class="content text">
							<h1 class="heading">Enter your username and password</h1>
						</div>
					</div>
