...
class hp extends CI_Controller {
	...
	public function tambah(){
		$this->form_validation->set_rules('kode_hp', 'kode_hp', 'trim|required');
		$this->form_validation->set_rules('nama_hp', 'nama_hp', 'trim|required');
	...
	public function tampil_ubah_hp($kode_hp){
		$data =  $this->mbk->tampil_ubah_hp($kode_hp);
	...
	public function hapus($kode_hp){
		if($this->mbk->hapus($kode_hp)){

			$this->session->set_flashdata('pesan', 'anda berhasil menghapus data menu hp');
			redirect('hp','refresh');

		}else{

			$this->session->set_flashdata('pesan', 'anda gagal menghapus data menu hp');
			redirect('hp','refresh');
		}
	}
}
